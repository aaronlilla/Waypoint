...
const __dirname = require$$1$4.dirname(__filename);
let mainWindow;
const createWindow = () => {
  mainWindow = new BrowserWindow({
    ...
    height: 1080,
    webPreferences: {
      preload: require$$1$4.join(__dirname, "preload.mjs"),
  ...
  const startUrl = isDev ? process.env.VITE_DEV_SERVER_URL : `file://${require$$1$4.join(__dirname, "../dist/index.html")}`;
